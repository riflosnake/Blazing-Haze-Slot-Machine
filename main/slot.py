...
class SlotMachine:
    def __init__(self):
        ...
        self.cards = self.get_images(
            [self.resource_path('cards/AC.png'), self.resource_path('cards/AS.png'), self.resource_path(
                'cards/AH.png'),
        ...
        self.active_symbols = self.get_images(
            [self.resource_path(r'activated_symbols/cherry.png'), self.resource_path(
                r'activated_symbols/lemon.png'),
